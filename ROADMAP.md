...
| | At kickoff | Now (Jul 2026, post-P26) | Powerhouse |
|---|---|---|---|
| Courses | 4 (Stats 1–4) | 9 (Methods, Data, Ethics, ML, Writing all complete) | **9** in two tracks |
| Lessons | 45 | 95 | **~95** |
| Tool pages | 8 | 15 (+ power calc, APA formatter, datasets, flashcards, which-chart, planner, correlation) | **~15** |

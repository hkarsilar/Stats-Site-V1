...
(function () {
  ...
  var SEARCH_PAGES = [
    ...
    { title: "Distribution Playground", url: "distributions.html", tag: "Tool", kw: "normal binomial poisson beta exponential uniform pdf explore distribution dice triangular sum of two dice" },
    ...
    { title: "Stats 1: Introduction to Statistics", url: "stats-1/", tag: "Course", kw: "stats 1 course introduction to statistics beginner start here overview syllabus ucg1rm11 moore descriptive statistics normal distribution z-scores producing data probability binomial sampling confidence intervals t-tests proportions chi-square correlation regression first course intro" },
    { title: "Stats 2: ANOVA & Regression", url: "stats-2/", tag: "Course", kw: "stats 2 course overview syllabus ucg2rm03 anova post-hoc factorial repeated measures assumptions nonparametric inference for regression multiple regression dummy coding interactions ancova logistic regression second course" },
    { title: "Stats 3: Advanced & Elective Topics", url: "stats-3/", tag: "Course", kw: "stats 3 course overview syllabus elective effect size power mediation manova factor analysis bootstrap bayesian glm multilevel mixed models cross-validation causal dags survival missing data meta-analysis signal detection advanced third course" },

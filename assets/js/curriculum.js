...
window.CURRICULUM = [
  {
    ...
    accent: "var(--primary)",
    sections: [
      { n: "1.1",  slug: "what-is-statistics",                 title: "What Is Statistics?" },
      ...
      { n: "1.9",  slug: "confidence-intervals",                title: "Confidence Intervals" },
      { n: "1.10", slug: "hypothesis-testing-logic",            title: "Hypothesis Testing Logic" },
      ...
      { n: "1.13", slug: "effect-size-and-power",               title: "Effect Size & Power" }
    ]
  },
  {
    slug: "stats-2",
    ...
    sections: [
      { n: "2.1",  slug: "one-way-anova",                  title: "One-Way ANOVA" },
      { n: "2.2",  slug: "post-hoc-tests",                 title: "Post-Hoc Tests" },
      ...
      { n: "2.8",  slug: "correlation",                    title: "Correlation" },
      { n: "2.9",  slug: "simple-linear-regression",       title: "Simple Linear Regression" },

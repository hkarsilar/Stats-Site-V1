...
window.SOFTWARE = {
  ...
  "effect-size-and-power": {
    ...
    jasp: [
      ...
      '<strong>Power → Independent Samples T-Test</strong>: enter effect size, α, and desired power, and JASP solves for n and draws the power curves.',
  ...
  "model-comparison": {
    spss: [
      ...
      '<em>Statistics…</em>: tick <em>R squared change</em>, and the output tests each block’s ΔR² with an F change test.',
  ...
  "manova": {
    ...
    jasp: [
      ...
      'Under <em>Additional Options</em>, choose the test statistic(s), ticking <em>Pillai</em> and <em>Wilks</em>, and tick the univariate <em>ANOVAs</em> box for follow-ups.'
    ],
  ...
  "power-analysis-for-complex-designs": {
    spss: [
      ...
      'For mixed/multilevel designs no formula applies, so simulate: generate data at your expected effect size many times and count how often the effect is detected.'
    ],
    jasp: [
  ...
  "bootstrap-and-resampling": {
    ...
    jasp: [
      'Several analyses expose bootstrapping directly. For example, <strong>T-Tests</strong> and <strong>ANOVA</strong> have a <em>bootstrap</em> option for effect sizes, and <strong>Mediation Analysis</strong> uses bootstrap CIs by default.',
  ...
  "generalized-linear-models": {
    spss: [
      ...
      'On <em>Type of Model</em>, pick the family: <em>Poisson loglinear</em> for counts, <em>Binary logistic</em> for yes/no.',
  ...
  "mixed-and-multilevel-models": {
    spss: [
      ...
      '<em>Random…</em>: tick <em>Include intercept</em> and select the subject variable. That’s a random-intercepts model, and you can add slopes there too if needed.',
  ...
  "missing-data": {
    spss: [
      ...
      'Run your analysis on the imputed dataset, and SPSS pools the estimates automatically (rows labeled <em>Pooled</em>).'
    ],
    jasp: [
      'JASP currently has no imputation module, so analyses use complete cases by default.',
  ...
  "reliability-and-validity": {
    ...
    tips: [
      ...
      'Reliability is a property of scores in <em>your</em> sample, not a fixed trait of the questionnaire, so report it for your own data rather than citing the manual.',
  ...
  "transformations-and-recoding": {
    spss: [
      ...
      'z-standardize the easy way: <strong>Analyze → Descriptive Statistics → Descriptives…</strong>, tick <em>Save standardized values as variables</em>, and SPSS writes a <code>Zx</code> column.',
    ...
    jasp: [
      ...
      'The new column is instantly available to any analysis, with no need to leave JASP.'
    ],
